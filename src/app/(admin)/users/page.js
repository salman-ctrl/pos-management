            ...
            {user.size === 'large' ? (
                ...
                <div className="h-full flex flex-col p-5">
                    ...
                    <div className="flex-1 flex flex-col justify-center">
                        <h3 className="font-bold text-gray-800 text-lg leading-tight line-clamp-1">{user.name}</h3>
                        <p className="text-orange-500 text-xs font-medium mb-3">{user.role}</p>
                        
                        <div className="flex flex-wrap gap-2 mt-auto">
                            <span className="px-2 py-1 bg-gray-50 text-gray-500 text-[10px] rounded-lg border border-gray-100 flex items-center gap-1">
                    ...
                    {(user.size === 'wide' || user.size === 'tall') && (
                         <div className="pt-3 mt-3 border-t border-gray-50 text-xs text-gray-400 flex items-center gap-1 truncate">
